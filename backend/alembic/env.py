...
# Cette ligne configure essentiellement loggers.
if config.config_file_name is not None:
    fileConfig(config.config_file_name)

# Récupérer l'URL de la base de données depuis les variables d'environnement
database_url = os.getenv('DATABASE_URL', 'sqlite:///data/database/vulnerability_agent.db')

# Si c'est PostgreSQL, convertir l'URL si nécessaire
